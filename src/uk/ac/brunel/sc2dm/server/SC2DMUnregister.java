 ...
 * Created: 15:17  - 2/08/11
 */

public class SC2DMUnregister extends AbstractSC2DMUnregister{
	/**
	 * 
	 */
	...
	public SC2DMUnregister(){
		callbackHandler = new SC2DMDefaultUnregistrationCallbackHandler();
